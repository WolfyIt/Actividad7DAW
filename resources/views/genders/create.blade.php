...
<body class="bg-dark text-light">
    <div class="container py-5">
        <h1 class="fw-bold mb-4">Crear Género</h1>
        ...
        <div class="card" style="background-color: #212529; border: 1px solid #495057; border-radius: 10px;">
            <div class="card-body text-light">
                <form action="{{ route('genders.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label text-light">Nombre del género</label>
                        <input type="text" class="form-control bg-dark text-light border-secondary" id="name" name="name" placeholder="Nombre del género" value="{{ old('name') }}" required>
                    </div>
